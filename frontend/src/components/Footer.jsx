...
function Footer() {
  return (
    <footer className="bg-[#151515] text-gray-400 pt-20">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 pb-20">
        ...
        {/* ── COLUMN 2: Our Blog ── */}
        <div className="flex flex-col gap-6">
          <h3 className="text-white text-base font-bold uppercase tracking-widest">
            Our Blog
          </h3>
          <ul className="flex flex-col gap-5">
            <li>
              <a href="#" className="hover:text-[#e8401c] transition-colors group">
                <h5 className="text-sm font-bold text-white uppercase mb-1 group-hover:text-[#e8401c]">
      ...
      {/* ── BOTTOM BAR ── */}
      <div className="bg-[#0a0a0a] py-6 text-center text-xs text-gray-500 tracking-wide border-t border-white/5 px-4">
