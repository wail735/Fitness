    ...
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {[
          ...
          <div key={i} className="bg-[#12141a] border border-slate-800/50 rounded-2xl p-5 flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-white leading-none">{s.value}<span className="text-xs text-slate-500 font-normal ml-1">{s.unit}</span></p>
            </div>
          </div>
        ))}
      </div>
      ...
      <div className="bg-[#12141a] border border-slate-800/50 rounded-3xl p-6">
        <div className="flex justify-between items-center mb-5">
          <h3 className="text-base font-semibold text-slate-200">Historique Récent</h3>
        ...
        {workouts.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {workouts.map((w, i) => (
              <div key={w._id || w.id || i} className="bg-[#0f1115] border border-slate-800/50 rounded-2xl p-4 hover:border-emerald-500/30 transition-colors">
                <div className="flex items-center justify-between mb-3">
                  <h4 className="font-semibold text-white text-sm">{w.name}</h4>
                ...
                <div className="flex items-center gap-3 text-xs mb-3">
                  ...
                  <span className="flex items-center gap-1 text-slate-400 bg-slate-800/50 px-2 py-1 rounded-lg">
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
          <div className="w-full max-w-md bg-[#12141a] border border-slate-800 rounded-3xl p-6 shadow-2xl">
            <div className="flex justify-between items-center mb-5">
              <h3 className="text-lg font-bold text-white">Ajouter une Séance</h3>
