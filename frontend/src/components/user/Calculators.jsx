...
export default function Calculators() {
  ...
  return (
    <div className="min-h-screen dark:bg-[#0b0c10] bg-slate-50 dark:text-white text-slate-900 pt-32 pb-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        {/* Tab Navigation */}
        <div className="flex flex-wrap justify-center gap-2 p-1.5 dark:bg-[#12141a] bg-white border dark:border-slate-800 border-slate-200/50 rounded-2xl">
          <button
            ...
            className={`flex items-center gap-2 px-5 py-2.5 rounded-xl font-semibold text-xs sm:text-sm transition-all ${
              activeTab === "bmi"
                ...
                : "dark:text-slate-400 text-slate-600 hover:dark:text-white hover:text-slate-900 hover:bg-slate-800/50"
            }`}
          >
        ...
        {/* Tab Contents */}
        <div className="dark:bg-[#12141a] bg-white border dark:border-slate-800 border-slate-200/50 rounded-2xl p-6 sm:p-8 shadow-xl">
          ...
          {activeTab === "bmi" && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div className="space-y-6">
                ...
                <div>
                  <div className="flex justify-between text-xs font-semibold dark:text-slate-300 text-slate-700 mb-2">
              ...
              {/* BMI Result Card */}
              <div className="flex flex-col items-center justify-center p-8 dark:bg-[#0b0c10] bg-slate-50 border dark:border-slate-800 border-slate-200/50 rounded-2xl text-center">
                <span className="text-slate-500 font-medium mb-2">Votre IMC est de</span>
                <span className="text-6xl font-black dark:text-white text-slate-900 mb-4">{bmiValue}</span>
                <div className={`px-4 py-2 rounded-lg font-bold text-sm ${bmiCat.bg} ${bmiCat.color}`}>
                  {bmiCat.label}
                </div>
                <p className="text-xs dark:text-slate-400 text-slate-600 mt-4 max-w-xs">
          ...
          {/* TAB 2: TDEE & Calories */}
          {activeTab === "tdee" && (
            <div className="dark:bg-[#12141a] bg-white border dark:border-slate-800 border-slate-200/50 rounded-3xl p-6 md:p-8 shadow-xl">
              <h3 className="text-xl font-bold dark:text-white text-slate-900 flex items-center gap-2 mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label className="block text-xs font-medium dark:text-slate-400 text-slate-600 mb-1">Sexe</label>
                      <select
                        value={tdeeGender}
                        onChange={(e) => setTdeeGender(e.target.value)}
                        className="w-full dark:bg-[#0b0c10] bg-slate-50 border dark:border-slate-800 border-slate-200/50 rounded-xl py-2 px-3 text-sm dark:text-white text-slate-900 focus:border-red-500 focus:outline-none"
                      >
                    ...
                    <div>
                      <label className="block text-xs font-medium dark:text-slate-400 text-slate-600 mb-1">Âge</label>
                      <input
                        type="number"
                        value={tdeeAge}
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label className="block text-xs font-medium dark:text-slate-400 text-slate-600 mb-1">Poids (kg)</label>
                      <input
                        type="number"
                        value={tdeeWeight}
                    ...
                    <div>
                      <label className="block text-xs font-medium dark:text-slate-400 text-slate-600 mb-1">Taille (cm)</label>
                      <input
                        type="number"
                        value={tdeeHeight}
                  ...
                  <div>
                    <label className="block text-xs font-medium dark:text-slate-400 text-slate-600 mb-1">Niveau d'activité physique</label>
                    <select
                      value={tdeeActivity}
                  ...
                  <div>
                    <label className="block text-xs font-medium dark:text-slate-400 text-slate-600 mb-1">Objectif principal</label>
                    <div className="flex dark:bg-[#0b0c10] bg-slate-50 border dark:border-slate-800 border-slate-200/50 rounded-xl p-1 gap-1">
                      <button
                        type="button"
                        onClick={() => setTdeeGoal("lose")}
                        className={`flex-1 py-1.5 text-xs font-semibold rounded-lg transition-colors ${
                          tdeeGoal === "lose" ? "bg-amber-600 dark:text-white text-slate-900" : "dark:text-slate-400 text-slate-600"
                        }`}
                      >
                        Sèche (-18%)
                      </button>
                      <button
                        ...
                        className={`flex-1 py-1.5 text-xs font-semibold rounded-lg transition-colors ${
                          tdeeGoal === "maintain" ? "bg-red-600 dark:text-white text-slate-900" : "dark:text-slate-400 text-slate-600"
                        }`}
                      >
                        Maintien
                      </button>
                      <button
                        ...
                        className={`flex-1 py-1.5 text-xs font-semibold rounded-lg transition-colors ${
                          tdeeGoal === "gain" ? "bg-emerald-600 dark:text-white text-slate-900" : "dark:text-slate-400 text-slate-600"
                        }`}
                      >
                        Prise de masse (+15%)
                      </button>
                ...
                {/* TDEE Output */}
                <div className="dark:bg-[#0b0c10] bg-slate-50 border dark:border-slate-800 border-slate-200/50 rounded-2xl p-6 flex flex-col justify-between space-y-4">
                  <div>
                    <span className="text-xs uppercase font-semibold text-slate-500">Métabolisme de Base (BMR)</span>
                    <div className="text-2xl font-bold dark:text-slate-200 text-slate-800 mb-4">{Math.round(bmr)} kcal/jour</div>
                    
                    <span className="text-xs uppercase font-semibold text-slate-500">Dépense Totale (TDEE Maintien)</span>
                    <div className="text-2xl font-bold dark:text-slate-200 text-slate-800 mb-4">{tdeeBase} kcal/jour</div>
                  </div>
                  ...
                  <div className="bg-red-600/10 border border-red-500/30 rounded-xl p-4 text-center">
                    ...
                    <div className="text-4xl font-extrabold dark:text-white text-slate-900 mt-1">{targetCalories} <span className="text-sm font-normal dark:text-slate-400 text-slate-600">kcal/jour</span></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          {activeTab === "macros" && (
            <div className="dark:bg-[#12141a] bg-white border dark:border-slate-800 border-slate-200/50 rounded-3xl p-6 md:p-8 shadow-xl">
              <h2 className="text-xl font-bold dark:text-white text-slate-900 mb-6">Répartition des Macronutriments</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div className="space-y-4">
                  ...
                  <div className="dark:bg-[#0b0c10] bg-slate-50 border dark:border-slate-800 border-slate-200/50 p-4 rounded-2xl flex items-center justify-between">
                    <div>
                    ...
                    <div className="text-right">
                      <span className="text-xl font-bold dark:text-white text-slate-900">{proteinGrams}g</span>
                  ...
                  <div className="dark:bg-[#0b0c10] bg-slate-50 border dark:border-slate-800 border-slate-200/50 p-4 rounded-2xl flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <span className="text-xl font-bold dark:text-white text-slate-900">{fatGrams}g</span>
                  ...
                  <div className="dark:bg-[#0b0c10] bg-slate-50 border dark:border-slate-800 border-slate-200/50 p-4 rounded-2xl flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <span className="text-xl font-bold dark:text-white text-slate-900">{carbGrams}g</span>
          ...
          {activeTab === "hydration" && (
            <div className="dark:bg-[#12141a] bg-white border dark:border-slate-800 border-slate-200/50 rounded-3xl p-6 md:p-8 shadow-xl">
              <h2 className="text-xl font-bold dark:text-white text-slate-900 mb-6">Besoins en Hydratation</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                
                <div className="space-y-5">
                  <div>
                    <label className="block text-xs font-medium dark:text-slate-400 text-slate-600 mb-1.5">Poids (kg)</label>
                    <input
                      type="number"
                      value={tdeeWeight}
                      onChange={(e) => setTdeeWeight(e.target.value)}
                      className="w-full dark:bg-[#0b0c10] bg-slate-50 border dark:border-slate-800 border-slate-200/50 rounded-xl py-3 px-4 dark:text-white text-slate-900 focus:border-red-500 focus:outline-none transition-colors"
                    />
                  </div>
                  <div>
                    <label className="block text-xs font-medium dark:text-slate-400 text-slate-600 mb-1.5">Niveau d'Activité</label>
                    <select
                      value={tdeeActivity}
                ...
                <div className="flex flex-col items-center justify-center p-8 dark:bg-[#0b0c10] bg-slate-50 border border-blue-500/30 shadow-[0_0_30px_rgba(59,130,246,0.1)] rounded-2xl text-center relative overflow-hidden">
                  <div className="absolute inset-0 bg-blue-500/5 blur-3xl rounded-full"></div>
                  <Droplets className="w-12 h-12 text-blue-400 mb-4 relative z-10" />
                  <span className="dark:text-slate-400 text-slate-600 font-medium mb-1 relative z-10">Volume Quotidien Recommandé</span>
                  <span className="text-5xl font-black dark:text-white text-slate-900 relative z-10">{hydrationLiters} <span className="text-lg dark:text-slate-400 text-slate-600 font-normal">Litres</span></span>
                </div>
